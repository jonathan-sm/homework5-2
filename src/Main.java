...
public class Main {
    public static void main(String[] args) {
        System.out.println("урок 2 массивы");
        ...
        int days = arr.length;
        double averageAmount = (double) sumForAvg / days;

        String messageAvg = String.format("Средняя сумма трат за месяц составила %s рублей", averageAmount);
